...
extern "C" bool fltk_theme()
{
    ...
    Fl_Image *gray   = Fl_Image::read_xpm(0, (const char **)bg_xpm);
    Fl_Image *blue = Fl_Image::read_xpm(0, (const char **)bg2_xpm);
    Fl_Image *light  = Fl_Image::read_xpm(0, (const char **)bg3_xpm);
