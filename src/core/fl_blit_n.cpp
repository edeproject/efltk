...
static void Blit_RGB888_index8(BlitInfo *info)
{
    int width, height;
    uint32 *src;
    const uint8 *map;
...
static void Blit_RGB888_RGB555(BlitInfo *info)
{
    int width, height;
    uint32 *src;
    uint16 *dst;
...
static void Blit_RGB888_RGB565(BlitInfo *info)
{
    int width, height;
    uint32 *src;
    uint16 *dst;
...
#endif
static void Blit_RGB565_32(BlitInfo *info, const uint32 *map)
{
    int width, height;
    uint8 *src;
    uint32 *dst;
...
extern const uint32 RGB565_ARGB8888_LUT[512];
static void Blit_RGB565_ARGB8888(BlitInfo *info)
{
    Blit_RGB565_32(info, RGB565_ARGB8888_LUT);
}

extern const uint32 RGB565_ABGR8888_LUT[512];
static void Blit_RGB565_ABGR8888(BlitInfo *info)
{
    Blit_RGB565_32(info, RGB565_ABGR8888_LUT);
}

extern const uint32 RGB565_RGBA8888_LUT[512];
static void Blit_RGB565_RGBA8888(BlitInfo *info)
{
    Blit_RGB565_32(info, RGB565_RGBA8888_LUT);
}

extern const uint32 RGB565_BGRA8888_LUT[512];
static void Blit_RGB565_BGRA8888(BlitInfo *info)
{
    Blit_RGB565_32(info, RGB565_BGRA8888_LUT);
}

static void BlitNto1(BlitInfo *info)
{
    int width, height;
    uint8 *src;
    const uint8 *map;
...
static void BlitNtoN(BlitInfo *info)
{
...
static void BlitNtoNCopyAlpha(BlitInfo *info)
{
    int width = info->d_width;
    int height = info->d_height;
    uint8 *src = info->s_pixels;
...
static void BlitNto1Key(BlitInfo *info)
{
    int width = info->d_width;
    int height = info->d_height;
    uint8 *src = info->s_pixels;
...
static void Blit2to2Key(BlitInfo *info)
{
    int width = info->d_width;
    int height = info->d_height;
...
static void BlitNtoNKey(BlitInfo *info)
{
    int width = info->d_width;
    int height = info->d_height;
    uint8 *src = info->s_pixels;
...
static void BlitNtoNKeyCopyAlpha(BlitInfo *info)
{
    int width = info->d_width;
    int height = info->d_height;
    uint8 *src = info->s_pixels;
...
#define COPY_ALPHA (1<<3)
struct blit_table {
	uint32 srcR, srcG, srcB;
	int dstbpp;
	uint32 dstR, dstG, dstB;
	Blit_Function blitfunc;
  int alpha;
};
static const struct blit_table normal_blit_1[] = {
	/* Default for 8-bit RGB source, an invalid combination */
	{ 0,0,0, 0, 0,0,0, 0, NO_ALPHA },
};
static const struct blit_table normal_blit_2[] = {
    { 0x0000F800,0x000007E0,0x0000001F, 4, 0x00FF0000,0x0000FF00,0x000000FF,
      Blit_RGB565_ARGB8888, SET_ALPHA },
    { 0x0000F800,0x000007E0,0x0000001F, 4, 0x000000FF,0x0000FF00,0x00FF0000,
      Blit_RGB565_ABGR8888, SET_ALPHA },
    { 0x0000F800,0x000007E0,0x0000001F, 4, 0xFF000000,0x00FF0000,0x0000FF00,
      Blit_RGB565_RGBA8888, SET_ALPHA },
    { 0x0000F800,0x000007E0,0x0000001F, 4, 0x0000FF00,0x00FF0000,0xFF000000,
      Blit_RGB565_BGRA8888, SET_ALPHA },

    /* Default for 16-bit RGB source, used if no other blitter matches */
    { 0,0,0, 0, 0,0,0, BlitNtoN, 0 }
};
...
static const struct blit_table normal_blit_4[] = {
    { 0x00FF0000,0x0000FF00,0x000000FF, 2, 0x0000F800,0x000007E0,0x0000001F,
      Blit_RGB888_RGB565, NO_ALPHA },
    { 0x00FF0000,0x0000FF00,0x000000FF, 2, 0x00007C00,0x000003E0,0x0000001F,
      Blit_RGB888_RGB555, NO_ALPHA },
...
Blit_Function get_blit_n(Fl_PixelFormat *srcfmt, Fl_PixelFormat *dstfmt, int flags)
{
    const struct blit_table *table;
    int which;
    Blit_Function blitfun = 0;
    ...
    if((flags & FL_BLIT_COLOR_KEY)) {
        ...
        if(srcfmt->bytespp == 2 && srcfmt->identity)
            return Blit2to2Key;
        else if(dstfmt->bytespp == 1)
            return BlitNto1Key;
        else {
    ...
    if(dstfmt->bitspp == 8) {
        ...
        table = normal_blit[srcfmt->bytespp-1];
        ...
        for ( which=0; table[which].srcR; ++which ) {
            if ( srcfmt->Rmask == table[which].srcR &&
                ...
                dstfmt->bytespp == table[which].dstbpp &&
    ...
    //printf("m %d  %d\n", srcfmt->bitspp, srcfmt->table ? 1 : 0);
