...
enum Fl_ODBC_Database_Capabilities {
   FL_DB_UNKNOWN = 0, 
...
public:
   Fl_ODBC_Database(const Fl_String connString)    { m_inTransaction = m_active = false; }
   virtual ~Fl_ODBC_Database()                     { close(); close_connection(); }
   ...
   // These methods should be implemented in actual database class
   virtual Fl_ODBC_Database_Capabilities capabilities() { return  FL_DB_UNKNOWN; }
