...
public:
	...
	virtual   void     draw(Fl_Widget *w)   {w->redraw();};
	...
	//fl_curve.cpp
	virtual void curve(float,float,float,float,float,float,float,float);
	//fl_arc.cpp
	virtual void arc(float x,float y,float w,float h, float a1, float a2);
	//fl_vertex.cpp
	...
	virtual void stroke();
	virtual void fill();
	virtual void fill_stroke(Fl_Color);
