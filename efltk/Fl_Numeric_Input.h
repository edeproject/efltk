...
public:
    ...
    : Fl_Input(x,y,w,h,l) {when(FL_WHEN_ENTER_KEY|FL_WHEN_RELEASE); text_align(FL_ALIGN_RIGHT);}
    ...
    : Fl_Input(l,layout_size,layout_al,label_w) {when(FL_WHEN_ENTER_KEY|FL_WHEN_RELEASE); text_align(FL_ALIGN_RIGHT);}
