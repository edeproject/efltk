...
public:
    ...
    Fl_CRadio_Buttons(const char* l = 0,int layout_size=30,Fl_Align layout_al=FL_ALIGN_TOP,int label_w=100)
    : Fl_Button_Group(const char* l,int layout_size,Fl_Align layout_al,int label_w) { type(RADIO_BUTTONS); }
};
