...
#define FL_LOGICAL_EVENTS   FL_EDIT_EVENTS|FL_USER_EVENTS|FL_BUTTON_EVENTS|FL_LIST_EVENTS|FL_WIDGET_EVENTS
...
enum Fl_Event_Types {
    ...
    FL_FOCUS_RECEIVED      = FL_FOCUS_EVENTS + 1, 
    ...
    FL_MENU_SHORTCUT           = FL_MENU_EVENTS + 2,
...
#define FL_FOCUS        FL_FOCUS_RECEIVED
...
#define FL_SHORTCUT FL_MENU_SHORTCUT
