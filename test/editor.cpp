...
Fl_Text_Display::Style_Table_Entry
    styletable[] = {	// Style table
        { FL_BLACK, FL_COURIER,        14 }, // A - Unfinished
        { FL_BLACK, FL_COURIER,        14 }, // B - Plain
        { FL_DARK3, FL_COURIER_ITALIC, 14 }, // C - Line comments
        { FL_DARK3, FL_COURIER_ITALIC, 14 }, // D - Block comments
        { fl_color_average(FL_BLACK, FL_YELLOW, 0.5), FL_COURIER,        14 }, // E - Strings
        { fl_color_average(FL_BLACK, FL_GREEN, 0.5),  FL_COURIER,        14 }, // F - Directives
        { fl_color_average(FL_BLACK, FL_RED, 0.5),    FL_COURIER,   14 }, // G - Types
        { fl_color_average(FL_BLACK, FL_BLUE, 0.5),   FL_COURIER,   14 }  // H - Keywords
    };
