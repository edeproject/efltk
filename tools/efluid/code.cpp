...
int write_code(const char *s, const char *t) 
{
	...
	const char *hdr = "// generated by Extended Fast Light User Interface Designer (eFluid) version %.4f\n\n";
	fprintf(header_file, hdr, FL_VERSION);
	fprintf(code_file, hdr, FL_VERSION);

	{
		Fl_String define_name;
		const char* a = fl_file_filename(t);
		define_name += '_';
	...
	if(i18n) write_declare("#include <efltk/Fl_Locale.h>");
...
void Fl_Type::write_static(int type) { }
...
void Fl_Type::write_strings(FILE *fp) 
{
