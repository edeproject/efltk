...
# ADD CPP /nologo /MD /W3 /GX /O2 /Ob2 /I "../visualc" /I "../.." /I "../" /I "." /D "NDEBUG" /D "_MSC_DLL" /D "WIN32" /D "_WINDOWS" /D "WIN32_LEAN_AND_MEAN" /D "VC_EXTRA_LEAN" /D "WIN32_EXTRA_LEAN" /D "FL_LIBRARY" /YX /FD /c
